...
import com.aries.library.fast.retrofit.FastUrlParser;
 ...
 * 5、2018-7-2 16:49:52 将控制多请求头功能由{@link MFastMultiUrl}移植至此方便统一管理
 ...
 */
public class MFastRetrofit {


    private static volatile MFastRetrofit sManager;
     ...
     */
    public static final String BASE_URL_NAME_HEADER = MFastMultiUrl.BASE_URL_NAME_HEADER;
    /**
     * 默认读、写、连接超时
     */
    ...
    private MFastRetrofit() {
        ...
        sRetrofitBuilder = new Retrofit.Builder()
                .addConverterFactory(MGsonFactory.create())// 创建自己的gson转换过滤器
                .addCallAdapterFactory(RxJava2CallAdapterFactory.create());
        setTimeout(mDelayTime);
        MFastMultiUrl.getInstance().with(sClientBuilder);
    }

    public static MFastRetrofit getInstance() {
        if (sManager == null) {
            synchronized (MFastRetrofit.class) {
                if (sManager == null) {
                    sManager = new MFastRetrofit();
                }
            }
        }
        return sManager;
    ...
    public Observable<ResponseBody> downloadFile(String fileUrl, Map<String, Object> header) {
        //下载前获取当前日志是否开启
        final boolean logEnable = MFastRetrofit.getInstance().isLogEnable();
        //下载前关闭日志功能--日志拦截器会不停拦截文件流造成无法进入onNext回调本地进行保存文件操作给人感觉就是卡住
        MFastRetrofit.getInstance().setLogEnable(false);
        return MFastRetrofit.getRetrofit()
                .create(MFastRetrofitService.class)
                .downloadFile(fileUrl, header == null ? new HashMap<>(0) : header)
                .doOnNext(responseBody -> {
                    //onNext回调前还原log状态
                    MFastRetrofit.getInstance().setLogEnable(logEnable);
                })
     ...
     * @return
     */
    public MFastRetrofit addHeader(String key, Object value) {
     ...
     * @return
     */
    public MFastRetrofit addHeader(final Map<String, Object> map) {
     ...
     * @return
     */
    public MFastRetrofit removeHeader(String key) {
     ...
     * @return
     */
    public MFastRetrofit removeHeader() {
        mHeaderMap.clear();
        return this;
    }
     ...
     * @return
     */
    public MFastRetrofit setBaseUrl(String baseUrl) {
        sRetrofitBuilder.baseUrl(baseUrl);
        MFastMultiUrl.getInstance().setGlobalBaseUrl(baseUrl);
        return this;
    }

    public MFastRetrofit setRetryOnConnectionFailure(boolean enable) {
        sClientBuilder.retryOnConnectionFailure(enable);
        return this;
    }

    public MFastRetrofit setTimeout(long second) {
        mDelayTime = second;
     ...
     * @return
     */
    public MFastRetrofit setTimeout(long second, TimeUnit unit) {
    ...
    public MFastRetrofit setReadTimeout(long second) {
     ...
     * @return
     */
    public MFastRetrofit setReadTimeout(long second, TimeUnit unit) {
        sClientBuilder.readTimeout(second, unit);
        return this;
    }

    public MFastRetrofit setWriteTimeout(long second) {
     ...
     * @return
     */
    public MFastRetrofit setWriteTimeout(long second, TimeUnit unit) {
        sClientBuilder.writeTimeout(second, unit);
        return this;
    }

    public MFastRetrofit setConnectTimeout(long second) {
     ...
     * @return
     */
    public MFastRetrofit setConnectTimeout(long second, TimeUnit unit) {
     ...
     * @return
     */
    public MFastRetrofit setCookieJar(CookieJar cookieJar) {
     ...
     * @return
     */
    public MFastRetrofit setLogJsonEnable(boolean enable) {
     ...
     * @return
     */
    public MFastRetrofit setLogEnable(boolean enable) {
     ...
     * @return
     */
    public MFastRetrofit setLogEnable(boolean enable, String tag) {
     ...
     * @return
     */
    public MFastRetrofit setLogEnable(boolean enable, String tag, HttpLoggingInterceptor.Level level) {
     ...
     * @return
     */
    public MFastRetrofit setCertificates(SSLSocketFactory sslSocketFactory, X509TrustManager trustManager) {
     ...
     * @return
     */
    public MFastRetrofit setCertificates() {
     ...
     * @return
     */
    public MFastRetrofit setCertificates(X509TrustManager trustManager) {
     ...
     * @return
     */
    public MFastRetrofit setCertificates(InputStream... certificates) {
     ...
     * @return
     */
    public MFastRetrofit setCertificates(InputStream bksFile, String password, InputStream... certificates) {
     ...
     * @return
     */
    public MFastRetrofit setCertificates(InputStream bksFile, String password, X509TrustManager trustManager) {
     ...
     * @return
     */
    public MFastRetrofit setUrlParser(FastUrlParser parser) {
        MFastMultiUrl.getInstance().setUrlParser(parser);
        return this;
    }
     ...
     * @return
     */
    public MFastRetrofit setUrlInterceptEnable(boolean enable) {
        MFastMultiUrl.getInstance().setIntercept(enable);
        return this;
    }
     ...
     * @return
     */
    public MFastRetrofit setHeaderPriorityEnable(boolean enable) {
        MFastMultiUrl.getInstance().setHeaderPriorityEnable(enable);
        return this;
    }
     ...
     * @return
     */
    public MFastRetrofit putHeaderBaseUrl(Map<String, String> map) {
        MFastMultiUrl.getInstance().putHeaderBaseUrl(map);
        return this;
    }
     ...
     * @return
     */
    public MFastRetrofit putHeaderBaseUrl(String urlKey, String urlValue) {
        MFastMultiUrl.getInstance().putHeaderBaseUrl(urlKey, urlValue);
        return this;
    }
     ...
     * @return
     */
    public MFastRetrofit removeHeaderBaseUrl(String urlKey) {
        MFastMultiUrl.getInstance().removeHeaderBaseUrl(urlKey);
        return this;
    }
     ...
     * @return
     */
    public MFastRetrofit removeHeaderBaseUrl() {
        MFastMultiUrl.getInstance().clearAllHeaderBaseUrl();
        return this;
    }
     ...
     * @return
     */
    public MFastRetrofit putBaseUrl(Map<String, String> map) {
        MFastMultiUrl.getInstance().putBaseUrl(map);
        return this;
    }
     ...
     * @return
     */
    public MFastRetrofit putBaseUrl(String method, String urlValue) {
        MFastMultiUrl.getInstance().putBaseUrl(method, urlValue);
        return this;
    }
     ...
     * @return
     */
    public MFastRetrofit removeBaseUrl(String method) {
        MFastMultiUrl.getInstance().removeBaseUrl(method);
        return this;
    }
     ...
     * @return
     */
    public MFastRetrofit removeBaseUrl() {
        MFastMultiUrl.getInstance().clearAllBaseUrl();
        return this;
    }
}
