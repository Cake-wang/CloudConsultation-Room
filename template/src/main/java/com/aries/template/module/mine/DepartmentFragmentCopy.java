...
// * @Description:
// */
//public class DepartmentFragmentCopy extends FastTitleFragment implements ISupportFragment {
//    private  Object obj;
...
//
//
//    public static DepartmentFragmentCopy newInstance(Object obj) {
//        Bundle args = new Bundle();
//        DepartmentFragmentCopy fragment = new DepartmentFragmentCopy();
...
//
//        findValidOrganProfessionForRevisit(appKey,tid,organId);
//    }
//
//    @SingleClick
...
////                .onPositive((dialog, which) -> cancelregister(appKey,tid,organId))
////                .show();
//    }
//
//    /**
...
//    }
//
//    public void findValidOrganProfessionForRevisit(String appKey,String tid,Integer organId) {
//
//        ApiRepository.getInstance().findValidOrganProfessionForRevisit(appKey,tid,organId,mContext)
//                .compose(this.bindUntilEvent(FragmentEvent.DESTROY))
//                .subscribe(true ?
//                        new FastLoadingObserver<FindValidOrganProfessionForRevisitResultEntity>("请稍后...") {
//                            @Override
//                            public void _onNext(@NonNull FindValidOrganProfessionForRevisitResultEntity entity) {
//                                if (entity == null) {
...
//                            }
//                        } :
//                        new FastObserver<FindValidOrganProfessionForRevisitResultEntity>() {
//                            @Override
//                            public void _onNext(@NonNull FindValidOrganProfessionForRevisitResultEntity entity) {
//                                if (entity == null) {
//                                    ToastUtil.show("请检查网络");
